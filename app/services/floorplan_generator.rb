class FloorplanGenerator
  ...
  def generate_with_openai
    ...
    # =======================================================
    # STANDARD PROMPTING
    # Default prompt for non-sketched floorplans
    # This is used when a floorplan is uploaded without any sketching
    # =======================================================
    post_body << "--#{boundary}\r\n"
  ...
  def generate_with_openai_from_sketch
    ...
    # Create a temporary file from the sketched image
    Tempfile.create(['input', '.png']) do |temp_file|
      temp_file.binmode
      temp_file.write(@floorplan.sketched_image.download)
      temp_file.rewind
    ...
    # =======================================================
    # SKETCHED PROMPTING 
    # Enhanced architectural floorplan generation by a master architect
    # This prompt is specifically used when a user has sketched
    # on their floorplan and checked the "sketch after upload" option
    # =======================================================
    post_body << "--#{boundary}\r\n"
    post_body << "Content-Disposition: form-data; name=\"prompt\"\r\n\r\n"
